...
## Booth design
- **Personal booth** unlocked after user identification.
- **Fast garment delivery** via rails/robotic arms.
- **Smart mirror** with configurable lighting and AR options.
- **Automatic sanitization** of garments and booth between sessions.
